...
def fila_atendimento():
    ...
    while True:
        ...
        print("Opção 0: Sair")
        print("Opção 1: Fila de Atendimento Sem Risco")
...
def cancelar_consulta():
    ...
    try:
        ...
        if confirmacao not in ("s", "sim"):
            ...
            resposta = int(input("Aperte 0 para sair\n>  ").strip())
            if resposta == 0:
                print("Redirecionando você de volta ao inicio")
                print("Carregando...")
                time.sleep(2.5)
                ...
                print("Error, Voltando ao menu inicial")
                print("Carregando...")
                time.sleep(2.5)
                main()   
...
def remarcar_consulta():
    ...
    try:
        ...
        if chave_nova not in medicos[nome_medico]["agenda"]:
            ...
            try:
                resposta = int(input("Aperte 0 para voltar ao início \n>  "))
            except ValueError:
                print("O valor inserido não é válido, Tenter novamente mais tarde...")
                print("Carregando...")
                time.sleep(2)
                principal()
        ...
        resposta = int(input("Aperte 0 para voltar ao início").strip())
        if resposta == 0:
            print("Redirecionando você de volta ao inicio")
            print("Carregando...")
            time.sleep(2.5)
...
def marcar_consulta():
    ...
    try:
        resposta_marcar_consulta = int(input(">  ").strip())
        ...
        nome_medico = input("Digite o nome do médico: (Letras Minúsculas ou Letras Maiúculas\n>  ").strip().upper()
        if nome_medico not in medicos:
            print("Médico não encontrado!")
            time.sleep(2)
            principal()
        ...
        if chave not in medicos[nome_medico]["agenda"]:
            ...
            try:
                ...
                print("Sua resposta gerou um Erro, digite apenas números inteiros (0)")
                principal()
            time.sleep(2.5)
            if resposta == 0:
                print("Redirecionando você de volta ao inicio")
        ...
        print("\nAperte 0 para Voltar ao início:")
        try:
            resposta = int(input(">  ").strip())
        except ValueError:
            print("A sua resposta é inválida, digite apenas (0)")
        ...
        if resposta == 0:
            ...
            time.sleep(2.5)
            principal()
        #Implementar este else em outros if resposta == 0 para a prevenção de erros 
        else:
            print("Error, Voltando ao menu inicial")
            print("Carregando...")
            time.sleep(2.5)
...
def especialistas():
    ...
    print("Aperte 0 para voltar ao menu inicial")
    try:
        resposta = int(input(">  ").strip())
    except ValueError:
        print("O valor inserido não é válido, Digite apenas (0)")
        print("Digite Enter para Sair:")
        input(">  ")
        print("Carregando...")
        time.sleep(2.5)
...
def principal():
    ...
    while True:
        ...
        try:
            resposta_opcoes = int(input(">  ").strip())
        except ValueError:
            print("O valor inserido não é válido.")
            time.sleep(2)
            continue
...
def logar():
    ...
    resposta_nome_completo = str(input(">  ").lower())

    print("Digite sua idade")
    try:
        resposta_idade = int(input(">  ").strip())
    except ValueError:
...
def cadastrar():
    ...
    print("Seus Dados estão corretos? (sim/nao)")
...
def main():
    ...
    print("O Senhor(a) possui cadastro em nosso sistema? (sim/nao | s/n)")
