...
def fila_atendimento():
    ...
    input("Aperte ENTER para ver novas filas ou sair:\n>  ")
    fila_atendimento()
...
def cancelar_consulta():
    ...
    nome_medico = input("Com qual médico você quer cancelar consulta? (Bernardo, João, Samara...)\n>  ").strip()
    ...
    try:
        ...
        if chave not in medicos[nome_medico]["agenda"]:
            print(f"Consulta:{dia} às {horario} com {nome_medico} não encontrada.\nAguarde o reinicio do sistema.")
            time.sleep(3)
            principal()
        ...
        salvar_dados()
        print(f"Consulta de {paciente_nome} cancelada! Horário do dia {dia} às {horario} liberado.")
        input("Aperte Enter para sair\n>  ")
        principal()
...
def remarcar_consulta():
    ...
    try:
        ...
        chave = f"{dia}|{horario}"
        if chave not in medicos[nome_medico]["agenda"]:
            print(f"Consulta por {nome_medico}, dia {dia} às {horario} não encontrada!\nAguarde o reinicio do sistema.")
            time.sleep(2)
            principal()
        ...
        if chave_nova not in medicos[nome_medico]["agenda"]:
            ...
            print(f"A consulta de {paciente_nome} foi de {dia} às {horario} --> {dia_novo} às {horario_novo} com o Dr(a).{nome_medico}.")
        ...
        if risco_paciente > nivel_ocupante:
            ...
            if encontrou_vaga:
                ...
                print(f"\nPaciente Deslocado: {paciente_ocupante_nome}")
                ...
                print("Não foi possível encontrar uma vaga para reorganizar as consultas. Tente outra opção.")
                input("Aperte ENTER para sair: ")
                main()
        else:
        ...
        print("A sua resposta é inválida (digite o dia em número).\nAguarde o reinicio do sistema.")
        time.sleep(2.5)
...
def marcar_consulta():
    ...
    try:
        ...
        print(f"\nHorários disponíveis: {medicos[nome_medico]['horarios']}")
        ...
        if chave not in medicos[nome_medico]["agenda"]:
            ...
            adicionar_na_fila()
            salvar_dados()
            print(f"Consulta marcada como: {nome_risco()}.\n Profissional: Dr(a).{nome_medico} no dia {dia} às {horario}.")
            input("Aperte ENTER para sair:\n>  ")
            main()
        ...
        if nivel_risco_atual > nivel_ocupante:
            ...
            if encontrou_vaga:
                ...
                print(f"\nPaciente Deslocado: {paciente_antigo}")
                print(f"Novo horário: dia {dia_novo} às {horario_novo}")
                print("\nTudo foi reorganizado com sucesso!")
            else:
...
def principal():
    ...
    print("Opção 0: Sair")
    print(f"\nOlá o senhor(a) {nome_completo}! Escolha uma Opção (0-5):")
...
def logar():
    ...
    print("Para fazer login, nos informe:")
    ...
    print("A senha que você cadastrou (CPF)")
    ...
    print("\nA sua resposta não corresponde aos dados reais, tente novamente ou contate o suporte.")
    input("Aperte ENTER para voltar ao menu inicial:")
    main()
...
def cadastrar():
    ...
    if nome == "" or segundo_nome == "":
        print("O nome e o sobrenome não podem ficar vazios.\nAguarde o reinicio do sistema.")
        time.sleep(2)
        cadastrar()
    ...
    for paciente in pacientes:
        if isinstance(paciente, dict) and paciente.get("cpf") == cpf_novo:
            print("ERRO: Conflito de cadastro.\nEsse CPF já está cadastrado.\nAguarde o reinicio do sistema.")
            time.sleep(2)
            cadastrar()
